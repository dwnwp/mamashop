        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="home.php"
                    ...
                    <img src="https://pngfre.com/wp-content/uploads/troll-face-poster.png" class="img-thumbnail"
                        width="40px">
                </a>
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                    <li>
                        <a href="<?php echo $base_url; ?>/admin-menu.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                class="bi bi-house-door d-block mx-auto mb-1" viewBox="0 0 16 16">
                                <path
                    ...
                    <li>
                        <a href="<?php echo $base_url; ?>/admin-ingredients.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                class="bi bi-cart3 d-block mx-auto mb-1" viewBox="0 0 16 16">
                                <path
                    ...
                    <li>
                        <a href="<?php echo $base_url; ?>/admin-order.php" class="nav-link text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                class="bi bi-menu-button-wide d-block mx-auto mb-1" viewBox="0 0 16 16">
                                <path
