        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                    <li>
                        <a href="<?php echo $base_url; ?>/pages/admin-menu.php" class="nav-link text-white">
                    ...
                    <li>
                        <a href="<?php echo $base_url; ?>/pages/admin-ingredients.php" class="nav-link text-white">
                    ...
                    <li>
                        <a href="<?php echo $base_url; ?>/pages/admin-order.php" class="nav-link text-white">
